...
public class CreateProject_PilotBankP2BTransaction  extends BaseTest{
	...
	@Test(priority = 17)
	public void verify_P2BTransaction() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 68, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description =  ExcelData.getData("projects", 69, 2);
