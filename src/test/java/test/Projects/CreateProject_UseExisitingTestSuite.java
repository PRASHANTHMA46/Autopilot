...
public class CreateProject_UseExisitingTestSuite extends BaseTest {
	...
	@Test(priority = 16)
	public void verify_SaveEditLanuch_UseExisitngTestSuite() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String Enteronlyalphabets = ExcelData.getData("projects", 59, 2);
		cp.Enter_ProjectTitle(Enteronlyalphabets);
		cp.Enter_ProjectDescription(Enteronlyalphabets);
		Thread.sleep(1000);
		cp.ClickOnUseExisiting();
		...
		Thread.sleep(1000);
		//Edit the title
		String Enteronlyalphabets2 = ExcelData.getData("projects", 61, 2);
		cp.Clear_ProjectTitle(Enteronlyalphabets);
	...
	@Test(priority = 17)
	public void verify_dateoflanuchandConfirmLanuch_UseExisitngTestSuite()
			throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
