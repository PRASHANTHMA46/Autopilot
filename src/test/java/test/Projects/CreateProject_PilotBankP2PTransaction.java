...
public class CreateProject_PilotBankP2PTransaction extends BaseTest {
	...
	@Test(priority = 17)
	public void verify_P2PTransaction() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
