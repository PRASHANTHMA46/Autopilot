...
public class CreateProject_CPMQuarterly extends BaseTest{
	...
	@Test(priority = 1)
	public void verify_CPMA_Quarterly() throws EncryptedDocumentException, IOException, InterruptedException {

		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 98, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description = ExcelData.getData("projects", 99, 2);
		...
		String Actual_Quarterly = cp.get_Frequency();
		System.out.println("Actual_Quarterly: " + Actual_Quarterly);
		String Expected_Quarterly = ExcelData.getData("projects", 103, 2);
		System.out.println("Expected_Quarterly: " + Expected_Quarterly);
		sa.assertEquals(Actual_CPM, Expected_CPM);
		sa.assertEquals(Actual_Quarterly, Expected_Quarterly);
		driver.findElement(By.xpath("(//a[normalize-space()='Golden Money Transfer'])[1]")).click();
		Thread.sleep(2000);
		String Actual_scheuledintwodays = cp.get_Scheduledstatus();
		System.out.println("Actual_scheuledintwodays: " + Actual_scheuledintwodays);
		String Expected_scheuledintwodays = ExcelData.getData("projects", 104, 2);
		System.out.println("Expected_scheuledintwodays " + Expected_scheuledintwodays);
		String Actual_scheduledquterly = cp.get_Scheduledquaterly();
		System.out.println("Actual_scheduledquterly: " + Actual_scheduledquterly);
		String Expected_scheuledquterly = ExcelData.getData("projects", 105, 2);
		System.out.println("Expected_scheuledquterly  " + Expected_scheuledquterly );
		sa.assertEquals(Actual_scheuledintwodays, Expected_scheuledintwodays);
		sa.assertEquals(Actual_scheduledquterly, Expected_scheuledquterly);
		Thread.sleep(2000);
		cp.clickon_pause();
