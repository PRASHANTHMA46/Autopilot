...
public class CreateProject_PilotBankAllTransaction extends BaseTest {
	...
	public void Verify_Destinationcountry() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		System.out.println("ActualdestinationCountry: " + destinationCountry);
		String expectedsoucountry = ActualDestinationcountry;
		System.out.println("expecteddestinationCountry: " + expectedsoucountry);
		SoftAssert sa = new SoftAssert();
		...
		String actualnooption = "No options";
		System.out.println("ActualdestinationCountry: " + actualnooption);
		String Nooption = driver
				.findElement(By.xpath(
						"//div[@class='react-select__menu-notice react-select__menu-notice--no-options css-1t1x6cd']"))
				.getText();
		System.out.println("expecteddestinationCountry: " + Nooption);
		sa.assertEquals(actualnooption, Nooption);
		sa.assertAll();
	}
	...
	public void verify_Defaultcurrency() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		sa.assertEquals(actualdefaultcurrency, expecteddefaultcurrency);
		sa.assertAll();
	}
	...
	@Test(priority = 16)
	public void verify_SaveEditLanuch() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String Enteronlyalphabets = RandomStringUtils.randomAlphabetic(10);
		cp.Enter_ProjectTitle(Enteronlyalphabets);
		...
		Thread.sleep(1000);
		//Edit the title
		String Enteronlyalphabets2 = RandomStringUtils.randomAlphabetic(10);
		cp.Clear_ProjectTitle(Enteronlyalphabets2);
		cp.Enter_ProjectTitle(Enteronlyalphabets2);
		Thread.sleep(3000);
		cp.clearLaunchDate();
		Thread.sleep(2000);
		cp.ClickLaunchDate();
	...
	@Test(priority = 17)
	public void verify_dateoflanuchandConfirmLanuch()
			throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 74, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description =  ExcelData.getData("projects", 75, 2);
