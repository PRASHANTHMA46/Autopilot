...
public class CreateProject_CPMAllTransaction extends BaseTest {
	...
	@Test(priority = 17)
	public void verify_Noof_occurrences()
	{
	...
	@Test(priority = 17)
	public void verify_CPMAllTransaction()throws EncryptedDocumentException, IOException, InterruptedException {
		
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 76, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description =  ExcelData.getData("projects", 77, 2);
