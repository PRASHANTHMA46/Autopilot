...
public class CreateProject_PilotWalletP2P extends BaseTest {
	...
	@Test(priority = 16)
	public void verify_SaveEditLanuch_WalletP2P() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
	...
	@Test(priority = 17)
	public void verify_PilotWalletP2P() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String Enteronlyalphabets = ExcelData.getData("projects", 46, 2);
		cp.Enter_ProjectTitle(Enteronlyalphabets);
