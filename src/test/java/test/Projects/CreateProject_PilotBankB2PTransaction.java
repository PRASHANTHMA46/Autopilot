...
public class CreateProject_PilotBankB2PTransaction extends BaseTest {
	...
	@Test(priority = 17)
	public void verify_B2PTransaction() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 70, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description =  ExcelData.getData("projects", 71, 2);
