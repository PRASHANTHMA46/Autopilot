...
public class CreateProject_CPMWeekly extends BaseTest {
	...
	public void Verify_projectDescription() throws InterruptedException, EncryptedDocumentException, IOException {
		 ...
		 * System.out.println("ActualclearTitleErrorMsg: " + ActualclearTitleErrorMsg);
		 * String ExpecetdclearTitleErrorMsg = ExcelData.getData("projects", 3, 2);
		 * System.out.println("ExpecetdclearTitleErrorMsg: " +
		 * ExpecetdclearTitleErrorMsg);
		 */
	}
	...
	@Test(priority = 16)
	public void verify_CPMSaveEditLanuch() throws EncryptedDocumentException, IOException, InterruptedException {
		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String Enteronlyalphabets = RandomStringUtils.randomAlphabetic(10);
		cp.Enter_ProjectTitle(Enteronlyalphabets);
		...
		Thread.sleep(1000);
		actions.scrollByAmount(0, 700).perform();
		String numberofaccurance = ExcelData.getData("projects", 85, 2);
        cp.EnterNumberOfOccurancy(numberofaccurance);
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		// Edit the title
		String Enteronlyalphabets2 = ExcelData.getData("projects", 87, 2);;
		cp.Clear_ProjectTitle(Enteronlyalphabets);
	...
	@Test(priority = 17)
	public void verify_CPMA_Weekly() throws EncryptedDocumentException, IOException, InterruptedException {

		// basic details enter to continue
		CreateProject cp = new CreateProject(driver);
		String title = ExcelData.getData("projects", 88, 2);
		cp.Enter_ProjectTitle(title);
		System.out.println("Title: " + title);
		String description = ExcelData.getData("projects", 89, 2);
